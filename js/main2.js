...
var $grid2 = $('[data-filter-group="treks"]').isotope({
  itemSelector: '.treks',
    layoutMode: 'fitRows'
});
...
$('.filters').on( 'click', 'li', function() {
  ...
  $grid2.isotope({ filter: 
                 function() {
    var attr = $(this).attr('data-yr');
    if(!filters['year'] == ''){
    return attr ==  filters[ 'year' ];
  }else{return true;}
                 } });
});
$('[data-filter-group="year"]').click(function(){
    $(' li.treks[data-filter=""] ').click();});
